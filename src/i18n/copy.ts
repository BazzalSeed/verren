  ...
  problem: {
    ...
    pages: [
      ...
      },
      {
        ...
        stat: '43%',
        statLabel: 'of wealth management firms are frustrated with their CRM’s effectiveness',
        source: 'F2 Strategy CRM benchmark, 2024',
      },
      {
        num: '03',
  ...
  problem: {
    ...
    pages: [
      ...
      },
      {
        ...
        stat: '43%',
        statLabel: '的财富管理机构对现有 CRM 的实际效果感到失望',
        source: 'F2 Strategy CRM 基准报告（2024）',
      },
      {
        num: '03',
